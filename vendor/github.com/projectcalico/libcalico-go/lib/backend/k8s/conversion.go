...
func (c converter) tprToGlobalConfig(tpr *custom.GlobalConfig) *model.KVPair {
	kvp := &model.KVPair{
...
func (c converter) globalConfigToTPR(kvp *model.KVPair) custom.GlobalConfig {
	tpr := custom.GlobalConfig{
